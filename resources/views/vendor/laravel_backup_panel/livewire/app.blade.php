<div class="container mb-5">
    <div class="d-flex align-items-end pt-4">
        <div class="d-flex align-items-end py-2 px-2">
            ...
            <button id="create-backup" class="btn mr-2 elevation-4 bg-navy btn-sm">
                Crear respaldo del sistema y base de datos
            </button>
            <button class="btn bg-navy elevation-4 btn-sm mr-2 ml-auto px-3" href="#" id="create-backup-only-db"
                wire:click.prevent="">
                Crear repaldo solo de la base de datos
            </button>
            <button class="btn bg-navy elevation-4 btn-sm ml-auto px-3" href="#" id="create-backup-only-files"
                wire:click.prevent="">
                Crear respaldo de archivos solo sistema
            </button>
        </div>
    </div>
                ...
                <table class="table table-hover mb-0">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">CANTIDAD DE COPIAS DE SEGURIDAD</th>
                            <th scope="col">COPIA DE SEGURIDAD MÁS RECIENTE</th>
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-body">
                                <h5 class="modal-title mb-3">Eliminar respaldos</h5>
                                @if($deletingFile)
                                <span class="text-muted"> ¿Está seguro de que desea eliminar la copia de seguridad creada en {{ $deletingFile['date'] }} ?
                                </span>
                                @endif
                            </div>
