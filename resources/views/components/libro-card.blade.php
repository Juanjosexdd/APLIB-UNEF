        ...
        <div class="mb-6 rounded-lg bg-white p-6">
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    <img class="mr-2 h-10 w-10 rounded-full object-cover" src="{{ $libro->profile_photo_url }}"
                        alt="profile" />
                    <div>
                ...
                <a href="{{route('libros.show', $libro)}}" class="text-sm font-medium text-indigo-500">+ Solicitar</a>
            </div>
